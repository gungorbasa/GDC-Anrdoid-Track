...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        erroMessageTextView = (TextView) findViewById(R.id.tv_error_message_display);
